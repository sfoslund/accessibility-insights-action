...
export const assessmentLink = MarkdownFormatter.link('https://accessibilityinsights.io/docs/en/web/getstarted/assessment', 'Assessments');
export const webToolLink = MarkdownFormatter.link('https://accessibilityinsights.io/docs/en/web/overview', webToolName);
export const wcag21AALink = MarkdownFormatter.link('https://www.w3.org/WAI/WCAG21/quickref/?currentsidebar=%23col_customize&levels=aaa', 'WCAG 2.1 AA');
