...
describe(ResultConsoleLogBuilder, () => {
    let combinedReportResult: CombinedReportParameters;
    let resultConsoleLogBuilder: ResultConsoleLogBuilder;
    ...
    beforeEach(() => {
        ...
        resultConsoleLogBuilder = new ResultConsoleLogBuilder(artifactsInfoProviderMock.object, new ConsoleLogFormatter());
    });

    it('builds error content', () => {
        expect(resultConsoleLogBuilder.buildErrorContent()).toMatchSnapshot();
    });

    it('builds content with failures', () => {
        setCombinedReportResultWithFailures();

        const actualContent = resultConsoleLogBuilder.buildContent(combinedReportResult);
    ...
    it('builds content with title', () => {
        ...
        const actualContent = resultConsoleLogBuilder.buildContent(combinedReportResult, title);
